    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white flex items-center justify-center">
      <div className="max-w-md mx-auto text-center p-8">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
          <span className="bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">Payment Canceled</span>
        </h1>
        ...
        <p className="text-sm text-gray-500 mt-8">
          Automatically redirecting in <span className="font-bold text-white">{countdown}</span> second{countdown !== 1 ? 's' : ''}...
        </p>
      </div>
    </div>
  );
